...
public class Assignment1 {
	...
	public class Banking {
		...
		public Banking() {
			System.out.println("Welcome to Sameer ko Bank!");
		}
	...
	private void initialize() {
		...
		firstNameTxt_create.setBounds(23, 10, 73, 16);
		createPanel.add(firstNameTxt_create);

		firstNameTxtField_create = new JTextField();
		firstNameTxtField_create.setBounds(21, 24, 130, 26);
		...
		createBtn.setBounds(254, 97, 130, 29);
		...
		firstNameTxt_deposit.setBounds(23, 10, 73, 16);
		depositPanel.add(firstNameTxt_deposit);

		firstNameTxtField_deposit = new JTextField();
		firstNameTxtField_deposit.setBounds(23, 31, 130, 26);
		...
		depositBtn.setBounds(255, 111, 130, 29);
		...
		firstNameTxt_withdraw.setBounds(24, 10, 73, 16);
		withdrawPanel.add(firstNameTxt_withdraw);

		firstNameTxtField_withdraw = new JTextField();
		firstNameTxtField_withdraw.setBounds(24, 36, 130, 26);
		...
		withdrawBtn.setBounds(259, 132, 130, 29);
		...
		checkBtn.setBounds(261, 125, 130, 29);
