...
public class Dashboard extends JPanel {
	...
	public Dashboard(JFrame frame,String role) {
		...
		deleteCourse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DeleteCourse add = new DeleteCourse();
			}
		});
		...
		editStudent.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				EditStudent add = new EditStudent();
			}
		});
		...
		deleteStudent.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DeleteStudent add = new DeleteStudent();
			}
		});
		...
		JLabel lblNewLabel_3 = new JLabel("Welcome Sameer!! \r\n\r\nback to HOME.");
